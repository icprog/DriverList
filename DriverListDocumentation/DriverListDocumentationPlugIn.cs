...
namespace DriverListDocumentation
{
    /// <summary>
    ...
    [HelpFileBuilderPlugInExport("DriverListDocumentation", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "DriverListDocumentation plug-in")]
    public sealed class DriverListDocumentationPlugIn : IPlugIn
    {
        ...
        public void Execute(ExecutionContext context)
        {
            ...
            builder.ReportProgress("In DriverListDocumentationPlugIn Execute() method");
        }
        #endregion
